...
<div class="container">
    <div class="card">
            ...
            <table class="table table-bodered  table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td>{{$dt->trangthai}}</td>  -->
                        <td>
                            <form action="{{route('detai2.destroy', $dt->madt)}}" method="POST">
                                <a href="{{route('detai2.edit', $dt)}}" class="btn btn-info">Chi tiết</a>
                                <script>
                                function myFunction() {
        ...
        {{$detai2->appends(Request::except('page'))->links() }}
    </div>
</div>
@endsection