...
<div class="container">
    <div class="card">
            ...
            <table class="table table-bodered  table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td>{{$dt->trangthai}}</td>  -->
                        <td>
                            <form action="{{route('detai1.destroy', $dt->madt)}}" method="POST">
                                <a href="{{route('detai1.edit', $dt)}}" class="btn btn-info">Chi tiết</a>
                                <script>
                                    function myFunction() {
        ...
        {{$detai1->appends(Request::except('page'))->links() }}
    </div>
</div>
@endsection